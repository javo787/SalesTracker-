...
export const ShopProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // value-объект пересоздавался инлайн на каждый рендер — все 50+
  // потребителей useShop() ре-рендерились при любом изменении в
  ...
  // сам useMemo был бы бесполезен (новая ссылка на функцию каждый рендер =
  // value всё равно пересоздаётся).

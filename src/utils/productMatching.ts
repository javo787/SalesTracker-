 ...
 *
 * Раньше здесь был Левенштейн по ВСЕЙ строке — из-за этого "Daniel" не
 * находил товар "рубашка Daniel" (8-символьный префикс "рубашка " размывал
 * оценку ниже порога), а кириллические варианты ("Даниел"/"Даниэл") вообще
 * не сопоставлялись с латиницей. tokenAwareSimilarity сравнивает запрос
 * с каждым словом названия отдельно и учитывает транслитерацию — см.
 * src/utils/matching/textSimilarity.ts и transliteration.ts.
 */

...
[
  {
    ...
    "summary_ru": "1-2 предложения: что произошло и как это влияет на закуп/цены товара",
    "summary_tg": "1-2 предложения на таджикском",
    "summary_uz": "1-2 предложения на узбекском",
